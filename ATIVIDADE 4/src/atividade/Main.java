...
public class Main {
	public static void main(String[] args) {
        ...
        Gerente gerente = new Gerente(35,"sillas nascimento","11122233345","Gerente Regional",5525.50, 0.15,"Norte-Nordeste",0); //Criando gerente
        Vendedor vendedor = new Vendedor(25,"lucas Jorge","66677788890","Vendedor Interno", 1550.50, gerente,0,0.05,0);//Criando vendedor
        Vendedor vendedor2 = new Vendedor(25,"maria de lurdes","12345678910","Vendedor Externo", 1550.50, gerente,0,0.05,0);//Criando outro vendedor
        ...
        Vendas vendas1 = new Vendas(300);
        Vendas vendas2 = new Vendas(950);
        Vendas vendas3 = new Vendas(725);
        Vendas vendas4 = new Vendas(400);
        Vendas vendas5 = new Vendas(780);
        Vendas vendas6 = new Vendas(1050);
        Vendas vendas7 = new Vendas(830);
        Vendas vendas8 = new Vendas(525);
        Vendas vendas9 = new Vendas(600);
